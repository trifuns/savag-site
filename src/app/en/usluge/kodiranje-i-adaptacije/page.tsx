    ...
    <div className="mx-auto max-w-4xl space-y-10">
      <header className="space-y-4">
        ...
        <p className="max-w-3xl text-sm leading-relaxed text-white/70">
          Module coding, adaptations and service message resets — done safely and in line with vehicle compatibility.
        </p>
      ...
      <section className="overflow-hidden rounded-3xl border border-white/10 bg-black/20">
        <img
          src={`${base}/services/hero-coding.jpg`}
          alt="Coding & adaptations"
