    ...
    <div className="mx-auto max-w-4xl space-y-10">
      <header className="space-y-4">
        ...
        <p className="max-w-3xl text-sm leading-relaxed text-white/70">
          Major service, oil and filter replacement, checks and service intervals — performed according to factory recommendations, efficiently and with quality.
        </p>
      ...
      <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-[2px] md:p-8">
        ...
        <ul className="mt-4 space-y-3 text-sm text-white/75">
          {[
            "Major service",
            "Oil and filter replacement (oil, air, cabin and fuel filters where applicable)",
            "Fluid check (brake, coolant, power steering, washer) and visual leak inspection",
            "Inspection of key components (belts, hoses, brakes, battery)",
            "Next service interval recommendation and service record",
          ].map((b, i) => (
