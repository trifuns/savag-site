    ...
    <div className="mx-auto max-w-4xl space-y-10">
      <header className="space-y-4">
        ...
        <p className="max-w-3xl text-sm leading-relaxed text-white/70">
          Thermostat, water pump, coolant and leaks — stable operating temperature and reliable engine performance.
        </p>
      ...
      <section className="overflow-hidden rounded-3xl border border-white/10 bg-black/20">
        <img
          src={`${base}/services/hero-cooling.jpg`}
          alt="Cooling system – A/C"
      ...
      <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-[2px] md:p-8">
        ...
        <ul className="mt-4 space-y-3 text-sm text-white/75">
          {[
            ...
            "Thermostat, fan and operating temperature inspection",
            "Water pump / thermostat replacement (as needed)",
            "Coolant replacement or system flush with final inspection",
          ].map((b, i) => (
