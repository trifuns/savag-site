    ...
    <div className="mx-auto max-w-4xl space-y-10">
      <header className="space-y-4">
        ...
        <p className="max-w-3xl text-sm leading-relaxed text-white/70">
          Suspension diagnostics and service — stability, comfort and safety without knocks or excessive play.
        </p>
      ...
      <section className="overflow-hidden rounded-3xl border border-white/10 bg-black/20">
        <img
          src={`${base}/services/hero-suspension.jpg`}
      ...
      <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-[2px] md:p-8">
        ...
        <ul className="mt-4 space-y-3 text-sm text-white/75">
          {[
            "Diagnosis of play and noises (visual inspection + test drive if needed)",
            "Replacement of links, bushings, tie-rod ends and shock absorbers (as needed)",
            "Inspection of bearings and mounts",
            "Recommendation for wheel alignment after the work",
          ].map((b, i) => (
